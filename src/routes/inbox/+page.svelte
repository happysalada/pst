                  ...
                  >
                    <div class="flex flex-row items-center">
                      ...
                      <div class="flex flex-row items-center space-x-px ml-4">
                        <div class="h-2 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-2 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-4 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-8 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-8 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-10 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-10 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-12 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-10 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-6 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-5 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-4 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-3 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-2 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-2 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-2 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-10 w-1 bg-gray-500 rounded-lg" />
                        ...
                        <div class="h-8 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-8 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-1 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-1 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-2 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-8 w-1 bg-gray-500 rounded-lg" />
                        <div class="h-8 w-1 bg-gray-500 rounded-lg" />
